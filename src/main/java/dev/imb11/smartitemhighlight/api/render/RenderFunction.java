...
public interface RenderFunction {
    ...
    RenderFunction NONE = (condition, stack, seed, graphics, x, y, z, hasRenderedItem) -> {};

    default Map<String, Class<?>> getSuggestedRenderOptions() {
        return Map.of();
    }

    void render(HighlightCondition condition, ItemStack stack, int seed, GuiGraphics graphics, int x, int y, int z, boolean hasRenderedItem);
}